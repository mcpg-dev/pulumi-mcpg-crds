 ...
 */
export class MCPGPluginSetPatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MCPGPluginSetPatch {
        return new MCPGPluginSetPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:mcpg.dev/v1alpha1:MCPGPluginSetPatch';

    /**
     * Returns true if the given object is an instance of MCPGPluginSetPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MCPGPluginSetPatch {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MCPGPluginSetPatch.__pulumiType;
    }
    ...
    declare public readonly spec: pulumi.Output<outputs.mcpg.v1alpha1.MCPGPluginSetSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.mcpg.v1alpha1.MCPGPluginSetStatusPatch>;
    ...
    constructor(name: string, args?: MCPGPluginSetPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MCPGPluginSetPatch.__pulumiType, name, resourceInputs, opts);
    }
}
