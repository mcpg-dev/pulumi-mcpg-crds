 ...
 */
export class MCPGCluster extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MCPGCluster {
        return new MCPGCluster(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:mcpg.dev/v1alpha1:MCPGCluster';

    /**
     * Returns true if the given object is an instance of MCPGCluster.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MCPGCluster {
    ...
    declare public readonly spec: pulumi.Output<outputs.mcpg.v1alpha1.MCPGClusterSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.mcpg.v1alpha1.MCPGClusterStatus>;
